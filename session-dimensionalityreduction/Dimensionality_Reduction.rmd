...
The data is assumed to be in ```~/scrna-seq2019/session-dimensionalityreduction/```. You can just change this to your preferred location, if you do not want to copy the data.
