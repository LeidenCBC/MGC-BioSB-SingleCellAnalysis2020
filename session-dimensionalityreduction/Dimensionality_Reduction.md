...
the Data Integration folder. You can just change this to your preferred
location.
...
```
    ...
    ## Ncells  2248502 120.1    4387285  234.4   3754506  200.6
    ## Vcells 48545030 370.4  204738018 1562.1 212915156 1624.5
...
There is not necesarily a clear winner. Hamming distances perform worse
...
already use color for gouping. With `label = TRUE` we can add a
